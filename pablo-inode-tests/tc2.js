describe('This test case verifies that each vehicle category displays correctly.', function () {
    ...
    it('verify that in Cars section only six cars exist', function () {
    ...
    it('verify that in Cars section exist with car proper names', function () {
    ...
    it('verify that in Cars section exist with MSRP in ascending order from left to right', function () {
